...
2. **Consumer classification.** Because MCP tools are invoked over the protocol boundary
   ...
   - **S1 — `mcpInstructions`** (`internal/mcp/server.go:354-431`): the literal
     server-side usage-protocol string served to every connecting MCP client at
     capability-negotiation time (`server.WithInstructions(mcpInstructions)`,
     `server.go:441`). Tool names appearing in its routing table are the strongest
     signal available short of production telemetry.
...
## 1. Full Inventory (91 tools)

| Tool | Consumers (evidence) | Classification | Replacement | Deprecation-eligible | Telemetry |
|---|---|---|---|---|---|
| `add_knowledge` | docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `add_procedural` | mcpInstructions routing table (internal/mcp/server.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `add_task` | mcpInstructions routing table (internal/mcp/server.go) / middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 1 event (local dev sqlite discipline_events, observed_at=2026-07-20T08:14:54.716Z) -- NOT representative of prod 30-day retention window |
| `add_vision_item` | mcpInstructions routing table (internal/mcp/server.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `analyze_agent_behavior` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `analyze_recent_patterns` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `apply_behavior_rules` | internal/scheduler/behavior_governance.go runBehaviorGovernance (weekly job) calls behaviorrule.Store.ApplyOutcome | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `assemble_context` | docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `begin_task` | middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 1 event (local dev sqlite discipline_events, observed_at=2026-07-20T08:15:00.527Z) -- NOT representative of prod 30-day retention window |
| `checkpoint_work` | middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `closeout_session_check` | docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
...
| `confirm_plan` | mcpInstructions routing table (internal/mcp/server.go) / middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `confirm_proposal` | middleware(significantTools, internal/mcp/middleware_autolog.go/middleware_classify.go) / docs/mcp-tools.md explicit 'Call' trigger / NOTE: Singular accept/reject. Batch sibling confirm_proposals exists but reject paths diverge (confirm_proposal.reject -> proposal.Resolve with distinct 'not found or already resolved' error; confirm_proposals.reject -> proposal.BatchConfirm, different response shape/error semantics -- tools_proposal.go:206-330) and confirm_proposals is NOT in the classify-middleware significantTools set (docs/mcp-tools.md:453) so auto-logging coverage differs. Consolidation possible but blocked on singular/batch parity -- not eligible today. | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `confirm_proposals` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) / NOTE: Batch sibling of confirm_proposal; accept path reuses acceptProposal per-id (parity), reject path uses a different store method (BatchConfirm) with different response shape -- see confirm_proposal note. | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `create_concept` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `create_goal` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `create_project` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `delete_task` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `deprecate_behavior_rule` | internal/scheduler/behavior_governance.go autoDeprecateStaleLowConfidenceRules (weekly job) calls behaviorrule.Store.Deprecate | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `detect_completion_candidates` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `detect_unclosed_loops` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `evaluate_outcome` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `extract_skill` | docs/internal/wayneblacktea-2.0-development-prompt.md Phase 4 'Skill Compiler' (no compiler/automation wired -- git log --all has zero P4/skill-compiler commits); docs/mcp-tools.md documents params only, no call-trigger | UNREACHABLE(P4) | - | No -- retained (UNREACHABLE P4 learning tool, explicitly preserved per dispatch boundary) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `find_failed_patterns` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `finish_work` | middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `generate_project_status` | docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `generate_reflection` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `get_active_work` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `get_due_reviews` | internal/scheduler/scheduler.go sendDailyReviewReminder (Discord daily reminder) + sendDailyNotionBriefing (DueReviews count in Notion briefing) call learning.CountDueReviews | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `get_latest_reflection` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `get_project` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `get_project_arch` | mcpInstructions routing table (internal/mcp/server.go) | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `get_task` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `get_today_context` | mcpInstructions routing table (internal/mcp/server.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `get_upcoming_work` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `get_work_session_trace` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `initial_instructions` | docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_active_repos` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_behavior_rules` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_decisions` | docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_goals` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_knowledge` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_pending_proposals` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_playbooks` | mcpInstructions routing table (internal/mcp/server.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_projects` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_recent_outcomes` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_recent_work_sessions` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_reflections` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_relevant_skills` | docs/internal/wayneblacktea-2.0-development-prompt.md Phase 4 'Skill Compiler' (no compiler/automation wired -- git log --all has zero P4/skill-compiler commits); docs/mcp-tools.md documents params only, no call-trigger | UNREACHABLE(P4) | - | No -- retained (UNREACHABLE P4 learning tool, explicitly preserved per dispatch boundary) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_tasks` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `list_vision_items` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `log_activity` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `log_decision` | mcpInstructions routing table (internal/mcp/server.go) / middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `mark_loop_resolved` | docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `mark_next_action_done` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) / NOTE: NOT equivalent to set_session_handoff (code-verified): mutates a single next_actions[step].status on an existing handoff (tools_session.go:101-122) without touching intent/context_summary/other steps; set_session_handoff always replaces the whole handoff record and has no per-step selector. | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `mark_procedural_used` | mcpInstructions routing table (internal/mcp/server.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `navigate_knowledge` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `outline_knowledge` | code-identical: handleOutlineKnowledge and the non-root branch of handleNavigateKnowledge both call s.knowledge.ListChildren(ctx,id) + navItemFromDB and return jsonText(nav) verbatim (internal/mcp/tools_knowledge_nav.go:65-114) | DEAD-CANDIDATE | navigate_knowledge(parent_id=item_id) | Tentative -- code-only evidence (see consumers), needs telemetry confirm before H4 removal | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `promote_atom_to_knowledge` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `promote_vision_to_task` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `propose_behavior_rule` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `propose_goal` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `propose_project` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `query_procedural` | mcpInstructions routing table (internal/mcp/server.go) | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `recall` | mcpInstructions routing table (internal/mcp/server.go) | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `reconcile_dashboard` | middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `reconcile_merged_prs` | .github/workflows/gtd-reconcile.yml POSTs to /api/tasks/reconcile-merged-prs on every PR merge (same BatchCompleteTasksByPRMatch logic) | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `record_outcome` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `resolve_handoff` | mcpInstructions routing table (internal/mcp/server.go) / middleware(significantTools, internal/mcp/middleware_autolog.go/middleware_classify.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `search_atoms` | NOT literally redundant today - recall's types param only accepts episodic/semantic/procedural (internal/mcp/tools_procedural.go:79-83), no atoms option. Future-consolidation candidate only; migrating would change response shape and requires extending recall first. Zero S1-S4 evidence of current use. | DEAD-CANDIDATE | recall (types=atoms, NOT YET SUPPORTED) | Tentative -- code-only evidence (see consumers), needs telemetry confirm before H4 removal | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `search_knowledge` | mcpInstructions routing table (internal/mcp/server.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `search_skills` | docs/internal/wayneblacktea-2.0-development-prompt.md Phase 4 'Skill Compiler' (no compiler/automation wired -- git log --all has zero P4/skill-compiler commits); docs/mcp-tools.md documents params only, no call-trigger | UNREACHABLE(P4) | - | No -- retained (UNREACHABLE P4 learning tool, explicitly preserved per dispatch boundary) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `set_session_handoff` | mcpInstructions routing table (internal/mcp/server.go) / middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) / docs/mcp-tools.md explicit 'Call' trigger / NOTE: Full handoff replace -- NOT a substitute for mark_next_action_done's per-step update. | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
...
| `start_work` | middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `submit_review` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `sync_repo` | middleware(significantTools, internal/mcp/middleware_autolog.go/middleware_classify.go) | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `sync_to_notion` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `system_health` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `task_checklist_add_item` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `task_checklist_complete` | code-identical: handleChecklistComplete builds the exact same gtd.UpdateChecklistItemParams{Done:&true} and calls the same s.gtd.UpdateChecklistItem as handleChecklistToggle when done=true/evidence_url omitted (internal/mcp/tools_gtd.go:1374-1425) | DEAD-CANDIDATE | task_checklist_toggle(item_id, done=true) | Tentative -- code-only evidence (see consumers), needs telemetry confirm before H4 removal | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `task_checklist_toggle` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `traverse_atoms` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `update_project` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `update_project_status` | middleware(significantTools, internal/mcp/middleware_autolog.go/middleware_classify.go) | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `update_skill_from_outcome` | docs/internal/wayneblacktea-2.0-development-prompt.md Phase 4 'Skill Compiler' (no compiler/automation wired -- git log --all has zero P4/skill-compiler commits); docs/mcp-tools.md documents params only, no call-trigger | UNREACHABLE(P4) | - | No -- retained (UNREACHABLE P4 learning tool, explicitly preserved per dispatch boundary) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `update_task` | mcpInstructions routing table (internal/mcp/server.go) / middleware(autoLogEntry, internal/mcp/middleware_autolog.go/middleware_classify.go) / NOTE: Cannot set status=completed (enum omits it, tools_gtd.go:274-276) -- set_task_status and complete_task are NOT redundant with this tool. | USED | - | No -- actively wired (USED) | 1 event (local dev sqlite discipline_events, observed_at=2026-07-20T08:33:31.744Z) -- NOT representative of prod 30-day retention window |
| `update_vision_item` | docs/mcp-tools.md (permissions matrix + param reference; no call-trigger sentence, no middleware/scheduler wiring found) | LATENT | - | No -- retained (LATENT, documented + registered; zero code-trigger is not removal authority) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `upsert_project_arch` | mcpInstructions routing table (internal/mcp/server.go) / middleware(significantTools, internal/mcp/middleware_autolog.go/middleware_classify.go) / docs/mcp-tools.md explicit 'Call' trigger | USED | - | No -- actively wired (USED) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
| `use_skill` | docs/internal/wayneblacktea-2.0-development-prompt.md Phase 4 'Skill Compiler' (no compiler/automation wired -- git log --all has zero P4/skill-compiler commits); docs/mcp-tools.md documents params only, no call-trigger | UNREACHABLE(P4) | - | No -- retained (UNREACHABLE P4 learning tool, explicitly preserved per dispatch boundary) | 0 events in local dev sqlite discipline_events; production (Aiven Postgres, 30-day retention) telemetry unavailable -- not queried (Boundaries: no prod DB connection) |
...
- `go test ./internal/mcp/... -run TestMCPServer_AllRegisteredToolsClassified -v`:
  ...
  `discipline.MutatingTools ∪ discipline.DeliberatelyExcludedTools` holds at 91/91.

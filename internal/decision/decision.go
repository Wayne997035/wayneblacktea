...
// carries no DSN, file path, or schema detail — capability errors must not
...
// caller-supplied payload (adversarial input / provenance integrity).
// manual does NOT prove a human confirmed the
...
type LogParams struct {
	...
	// from a caller-supplied payload (adversarial input / provenance
	// integrity). Populated by every
	...
	// that confirmation gate does not

...
type SessionHandoff struct {
	...
	CreatedAt      pgtype.Timestamptz `json:"created_at"`
	WorkspaceID    pgtype.UUID        `json:"workspace_id"`
	// NextActions holds the raw JSON of the next_actions JSONB column
	// (migration 000046). Not generated by sqlc — maintained manually.
	// Stores marshal []session.NextAction; callers decode it as needed.
	NextActions []byte `json:"next_actions,omitempty"`
}
...
type Task struct {
	...
	// PR/branch tracking fields added by migration 000047. Not sqlc-generated.
	BranchName pgtype.Text `json:"branch_name,omitempty"`
	PRUrl      pgtype.Text `json:"pr_url,omitempty"`
